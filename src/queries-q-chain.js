...
//
// This module covers single-fact questions sourced from external full
// nodes — currently Monero (`monerod`) and Zcash (`zebra`) — exposed at
// $0.001 each via the x402 paywall.
//
...
// handler in the REST plugin wraps THAT in a chain-cache so a hot
...
// ── question registry ────────────────────────────────────────────
//
// The registry is intentionally separate from any DeFi questions so
// the chain wiring can be lazy-loaded; the REST plugin merges this
